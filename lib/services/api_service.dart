...
class APIService {
  static const apiKey = 'ac3204e409msh17b656760a9b400p15150cjsna2ac7afe5e91';
  static const baseURL = 'exercises-by-api-ninjas.p.rapidapi.com';

  static Future<List<Exercise>> fetchExercises({String? name, String? type, String? muscle, String? difficulty, int? offset}) async {
    Map<String, String> queryParams = {};
    //need to check if query is valid
